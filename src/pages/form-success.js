...
export default function Index(){
  return(
    <Layout location={"/"}>
      <SuccessTem title="Contact" message={"Thanks for getting in touch! Your form has been sent to the team at Kokatahi Accomodation and they will be in touch as soon as possible."}/>
    </Layout>
  )
}
